...
public class String_tocharAt_1 {
	...
	static int count_of_specialcharecters =0 ;
public static void main(String[] args) {
		...
		System.out.println("Finding Special charecters:");
		count_of_specialcharecters = (input.length()-(count_of_alphabet+count_of_space+count_of_numeric ));
		System.out.println(count_of_specialcharecters);
	}
